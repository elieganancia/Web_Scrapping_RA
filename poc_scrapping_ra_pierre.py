...
label_list_content = get_content("https://www.residentadvisor.net/labels.aspx?show=all")
...
data_labels = pd.DataFrame({'name':label_names, 'url':label_urls, 'id':label_ids})
data_labels['url'] = base_url + data_labels['url']


######---> specific labels

list_url_label = list(data_labels['url'])
list_name_label = list(data_labels['name'])
...
data_label_information = pd.DataFrame({'Name':list_name_label, 'Creation':date_creation_labels,
...
artist_list_content = get_content("https://www.residentadvisor.net/dj.aspx")
...
data_artist = pd.DataFrame({'name':artist_names, 'url':artist_urls, 'id':artist_ids})



#---> specific artist

list_url_artist = list(data_artist['url'])
...
data_artist_informations = pd.DataFrame({'Name':artist_names, 'Origin':artist_basis_locations,
                                         ...
                                         'Famous_location':artist_famous_locations, 'Famous_clubs':artist_famous_clubs})
